...
namespace Recorder
{
    public partial class MainWindow : Form
    {
        ...
        private double minAmplitude = float.MaxValue;
        private double maxAmplitude = float.MinValue;
        private double sumAmplitude = 0.0;
        ...
        private void MainWindow_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                MessageBox.Show("Спочатку зупиніть запис аудіо");
            }
        }
